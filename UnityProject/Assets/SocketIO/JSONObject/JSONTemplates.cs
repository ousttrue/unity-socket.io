		...
		if(touched.Add(obj)) {
			...
			foreach(FieldInfo fi in fieldinfo) {
				...
				if(val) {
					...
					else JSONObject.LogWarning("Null for this non-null object, property " + fi.Name + " of class " + obj.GetType().Name + ". Object type is " + fi.FieldType.Name);
				}
			}
			//Properties
			...
			foreach(PropertyInfo pi in propertyInfo) {
				...
				if(val) {
					...
					else JSONObject.LogWarning("Null for this non-null object, property " + pi.Name + " of class " + obj.GetType().Name + ". Object type is " + pi.PropertyType.Name);
				}
			}
			return result;
		} 
		JSONObject.LogWarning("trying to save the same data twice");
